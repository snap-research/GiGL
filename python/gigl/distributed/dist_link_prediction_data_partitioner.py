...
class DistLinkPredictionDataPartitioner:
    ...
    def __assert_and_get_rpc_setup(self) -> None:
        """
    ...
    def register_node_ids(
        ...
        self.__assert_and_get_rpc_setup()
    ...
    def __partition_node(self, node_type: NodeType) -> PartitionBook:
    ...
    def __partition_edge_features(
        ...
        Args:
            edge_partition_book (Dict[EdgeType, PartitionBook]): The partition book of edges
        ...
        del self._edge_feat_dim[edge_type], edge_feat_dim
    ...
    def partition_edge(
        ...
        Tuple[GraphPartitionData, PartitionBook],
        Tuple[Dict[EdgeType, GraphPartitionData], Dict[EdgeType, PartitionBook]],
    ]:
        """
    ...
    def partition_edge_features(
        self, edge_partition_book: Union[PartitionBook, Dict[EdgeType, PartitionBook]]
        ...
        self.__assert_data_type_consistency(
            input_entity=transformed_edge_partition_book,
        ...
        edge_feature_types = sorted(self._edge_feat.keys())

        partitioned_edge_features: Dict[EdgeType, FeaturePartitionData] = {}
        for edge_type in edge_feature_types:
