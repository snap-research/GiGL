...
class UserDefinedLabelsNodeAnchorBasedLinkPredictionTask(
  ...
  def run(): Unit = {
    ...
    // TODO (tzhao-sc): The following ~10 line of codes assumes homogeneous graphs, need to update to support heterogeneous graphs in HGS phase3.
  ...
  def createSampleSubgraph(
    ...
    // TODO (yliu-sc) maybe we can operate all on hydrated
